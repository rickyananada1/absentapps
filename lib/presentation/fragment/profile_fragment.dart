          ...
          children: [
            Column(
              ...
              children: [
                Column(
                  children: [
                    CommonCachedNetworkImage(user,
                        width: 130, height: 130, fit: BoxFit.cover, radius: 75),
                    16.height,
                ...
                Align(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          const Icon(Icons.logout, color: white, size: 24),
                          8.width,
                          Text('Keluar', style: boldTextStyle(color: white)),
                        ],
                      ),
                    ),
                  ),

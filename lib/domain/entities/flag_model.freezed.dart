...
class _$FlagImpl implements _Flag {
  const _$FlagImpl({required this.id, required this.value});
...
abstract class _Flag implements Flag {
  const factory _Flag({required final int id, required final String value}) =
      _$FlagImpl;
